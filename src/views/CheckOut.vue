      ...
      <v-row dir="rtl">
        <v-col cols="12" md="6" lg="7" class="order-1 order-md-0">
          ...
          >
            ...
            <div
              class="user-name d-flex justify-center align-center mb-3"
              style="gap: 15px"
            >
              <v-text-field
                label="الاسم الأول"
            ...
            />
            <div
              class="states d-flex justify-center align-center mb-3"
              style="gap: 15px"
            >
              <v-select
                name=""
          ...
          >
            ...
            >
              <v-card
                ...
                :key="product.id"
                class="d-flex py-2 justify-space-between align-center mb-4"
                style="width: 100%"
              >
                <v-badge
                  location="top left"
                ...
                <v-card-text
                  class="flex-grow-0"
                  style="color: #3f3f3f; font-size: 13px"
                >
                  EGP
                  {{
                    Math.ceil(
            ...
            <v-divider length="100%" color="#6d3501"></v-divider>
            <v-divider length="100%" color="#6d3501"></v-divider>
            <v-divider length="100%" color="#6d3501"></v-divider>
            <v-card-text
              ...
              style="letter-spacing: normal"
            >
              <span>الإجمالي الكلي</span><span>EGP {{ calcTotalPrice }}</span>
            </v-card-text>
          </v-card>
        </v-col>
      </v-row>
...
const firstNameRule = ref([(value) => !!value || "ادخل الاسم الأول"]);
const secondNameRule = ref([(value) => !!value || "ادخل الاسم الأخير"]);
